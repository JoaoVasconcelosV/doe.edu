...
export default function SliderScreen({ navigation }) {
  ...
  function RenderItem({ item }) {
    return (
      <View style={styles.slide}>
        ...
        <Text style={{ ...styles.title, fontSize: EStyleSheet.value("3rem") }}>
          doe.edu
        </Text>
        <Text style={{ ...styles.text, fontSize: EStyleSheet.value("1rem") }}>
          {item.text}
        </Text>
      </View>
    );
      ...
      <View style={loginStyles.view}>
        ...
        >
          <Text
            style={{
              ...loginStyles.text,
              fontSize: EStyleSheet.value("0.875rem"),
            }}
          >
            Entrar
          </Text>
  ...
  return (
    <AppIntroSlider
      ...
      renderDoneButton={() => (
        <Button color="#22B07E" onPress={setFirstAccess} title="Concluir" />
      )}
